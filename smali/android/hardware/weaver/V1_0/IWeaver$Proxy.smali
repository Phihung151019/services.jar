...
.method public final read(ILjava/util/ArrayList;Landroid/hardware/weaver/V1_0/IWeaver$readCallback;)V
    .locals 11
    ...
    invoke-interface {p0, p1, v0, v2, p2}, Landroid/os/IHwBinder;->transact(ILandroid/os/HwParcel;Landroid/os/HwParcel;I)V
    ...
    new-instance p1, Landroid/hardware/weaver/V1_0/WeaverReadResponse;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput p2, p1, Landroid/hardware/weaver/V1_0/WeaverReadResponse;->timeout:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p1, Landroid/hardware/weaver/V1_0/WeaverReadResponse;->value:Ljava/util/ArrayList;
    ...
    iput v3, p1, Landroid/hardware/weaver/V1_0/WeaverReadResponse;->timeout:I
    ...
    iget-object v3, p1, Landroid/hardware/weaver/V1_0/WeaverReadResponse;->value:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-interface {p3, p0, p1}, Landroid/hardware/weaver/V1_0/IWeaver$readCallback;->onValues(ILandroid/hardware/weaver/V1_0/WeaverReadResponse;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final toString()Ljava/lang/String;
    ...
    :catch_0
    const-string/jumbo p0, "[class or subclass of android.hardware.weaver@1.0::IWeaver]@Proxy"
