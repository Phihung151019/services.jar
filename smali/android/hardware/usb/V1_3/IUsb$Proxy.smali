...
# direct methods
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hardware/usb/V1_3/IUsb$Proxy;
    .locals 6
    ...
    :cond_1
    const-string/jumbo v1, "android.hardware.usb@1.3::IUsb"
    ...
    instance-of v3, v2, Landroid/hardware/usb/V1_3/IUsb$Proxy;

    if-eqz v3, :cond_2

    move-object v0, v2

    check-cast v0, Landroid/hardware/usb/V1_3/IUsb$Proxy;
    ...
    iput-object p0, v2, Landroid/hardware/usb/V1_3/IUsb$Proxy;->mRemote:Landroid/os/IHwBinder;

    :try_start_0
    invoke-virtual {v2}, Landroid/hardware/usb/V1_3/IUsb$Proxy;->interfaceChain()Ljava/util/ArrayList;
...
.method public final enableContaminantPresenceDetection(Ljava/lang/String;Z)V
    .locals 2
...
.method public final enableUsbDataSignal(Z)Z
    .locals 3
...
.method public final queryPortStatus()V
    .locals 4
...
.method public final setCallback(Landroid/hardware/usb/V1_0/IUsbCallback;)V
    .locals 3
    ...
    :cond_0
    check-cast p1, Lcom/android/server/usb/hal/port/UsbPortHidl$HALCallback;
...
.method public final switchRole(Ljava/lang/String;Landroid/hardware/usb/V1_0/PortRole;)V
    .locals 2
...
.method public final toString()Ljava/lang/String;
    ...
    :catch_0
    const-string/jumbo p0, "[class or subclass of android.hardware.usb@1.3::IUsb]@Proxy"
