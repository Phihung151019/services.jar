...
# direct methods
.method public static getService()Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;
    .locals 6
    ...
    instance-of v3, v2, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;

    if-eqz v3, :cond_1

    check-cast v2, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;
    ...
    iput-object v0, v2, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;->mRemote:Landroid/os/IHwBinder;

    :try_start_0
    invoke-virtual {v2}, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;->interfaceChain()Ljava/util/ArrayList;
...
.method public final toString()Ljava/lang/String;
    ...
    :catch_0
    const-string/jumbo p0, "[class or subclass of android.hardware.authsecret@1.0::IAuthSecret]@Proxy"
