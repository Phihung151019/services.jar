...
.method public final dumpServiceClient(Lcom/android/server/am/ServiceRecord;)V
    ...
    invoke-virtual {v0, v2, p1, v3}, Landroid/app/IApplicationThread$Delegator;->dumpService(Landroid/os/ParcelFileDescriptor;Landroid/os/IBinder;[Ljava/lang/String;)V
...
.method public final dumpUserRemainsLocked(I)V
    ...
    invoke-virtual {v7, v9, v8}, Lcom/android/server/am/ActivityManagerService$ItemMatcher;->match(Landroid/content/ComponentName;Ljava/lang/Object;)Z
    ...
    iget-object v7, v8, Lcom/android/server/am/ServiceRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    const-string v7, " delayed start services:"

    invoke-static {p1, v6, v5, v7}, Lcom/android/server/am/ActiveServices$$ExternalSyntheticOutline0;->m(ILjava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v8, v3}, Lcom/android/server/am/ActivityManagerService$ItemMatcher;->match(Landroid/content/ComponentName;Ljava/lang/Object;)Z
    ...
    invoke-static {p1, v8, v5, v9}, Lcom/android/server/am/ActiveServices$$ExternalSyntheticOutline0;->m(ILjava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;)V
