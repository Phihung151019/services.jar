...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "NapHandler"
...
.method public static versionCompare(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_3
    const-string/jumbo p1, "NetworkAnalytics:Service"
...
.method public final _activateNAPClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;II)Z
    ...
    invoke-static {v2, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v0, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->binderMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->napInterface:Lcom/samsung/android/knox/net/nap/serviceprovider/INetworkAnalyticsService;
    ...
    iget-object v1, v2, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->jsonString:Ljava/lang/String;
    ...
    const-string/jumbo p2, "_activateNAPClient: Remote Exception"
...
.method public final _bindAndActivate(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;II)V
    ...
    :try_start_0
    new-instance p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;

    invoke-direct {p3, p0, p1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;-><init>(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V

    new-instance v2, Ljava/util/concurrent/CountDownLatch;

    invoke-direct {v2, v1}, Ljava/util/concurrent/CountDownLatch;-><init>(I)V

    iput-object v2, p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->countDownLatch:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {p0, p3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_bindToClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;)I
    ...
    invoke-static {v4, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, v4}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object p3, p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->profilesForPackage:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->binderMap:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {p3, v3}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;
    ...
    :cond_3
    iget-object v3, p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->countDownLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    iput-object v4, p3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->countDownLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    const-string/jumbo v3, "_bindAndActivate:PROFILE_ACTIVATED: Adding to data delivery"
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getAllProfilesForPackage(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getAllProfilesForUser(I)Ljava/util/List;
    ...
    const-string/jumbo p1, "_bindAndActivate: no profile found for user. Not adding profile to recipient list on NetworkAnalyticsDataDelivery"
    ...
    iget-object v4, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->packageName:Ljava/lang/String;
    ...
    iget v6, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    invoke-virtual {v4, v6, v5}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->isProfileActivatedForUser(ILjava/lang/String;)I

    move-result v4

    if-ne v4, v1, :cond_7

    iget v4, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    new-instance v5, Lcom/android/server/enterprise/nap/DataDeliveryHelper;

    invoke-direct {v5, v3, p3, v4}, Lcom/android/server/enterprise/nap/DataDeliveryHelper;-><init>(Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;I)V
    ...
    const-string v7, "Adding the profile to the delivery list _bindAndActivate "
    ...
    iget-object v3, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDataDelivery:Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;

    invoke-virtual {v3, v5}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->addNAPDataRecipient(Lcom/android/server/enterprise/nap/DataDeliveryHelper;)V
    ...
    invoke-static {v2, p3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->versionCompare(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p3, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->openCharDevice(I)I
    ...
    const-string/jumbo p1, "_bindAndActivate:PROFILE_ACTIVATED:Opening of character device failed."
    ...
    invoke-virtual {p3, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->openCharDevice(I)I
    ...
    invoke-static {p2, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p3, v2, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->addProfileForPackage(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo p1, "_bindAndActivate: no profile found. Not begining to record data"
    ...
    invoke-virtual {p3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->checkNcmVersionMismatch()I
    ...
    const-string/jumbo p3, "_bindAndActivate: version mismatch deactivation failed for profile : "
    ...
    const-string p1, " but data collection will not happen."
    ...
    :cond_c
    iget p2, p2, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I
    ...
    const-string/jumbo p3, "_bindAndActivate:PROFILE_ACTIVATED:Version mismatch between user and kernel space. Deactivated this profile : "
    ...
    iget-object v0, p2, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->profileName:Ljava/lang/String;

    iget p2, p2, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    invoke-static {p2, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p3, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getActiveStateForName(Ljava/lang/String;)Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;
    ...
    const-string/jumbo p1, "_bindAndActivate: no active profile found. Not begining to record data"
    ...
    const-string/jumbo p3, "_bindAndActivate: set interval value and deactivation failed for profile : "
    ...
    invoke-virtual {p3, v0, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->removeProfileForPackage(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p3, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDataDelivery:Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;

    iget-object v0, p1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    invoke-virtual {p3, p2, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->removeNAPDataRecipient(ILjava/lang/String;)V
    ...
    iget-object p3, p1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;

    iget v0, p1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I

    invoke-static {v0, p3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo p2, "_bindAndActivate Exception"
    ...
    const-string/jumbo p2, "_bindAndActivate RemoteException"
...
.method public final _bindAndActivate(Ljava/lang/String;Z)V
    ...
    :cond_0
    iget v1, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;->activationState:I
    ...
    :cond_1
    iget-object v0, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;->profile:Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;
    ...
    iget-object v3, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->packageSignature:Ljava/lang/String;

    iget v4, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->userId:I

    const-string/jumbo v5, "NetworkAnalytics:Service"

    const-string/jumbo v6, "validateNAPClient:Valid monitor application is not installed "

    :try_start_0
    invoke-virtual {p0, v4, v2, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->isValidAppInstalled(ILjava/lang/String;Ljava/lang/String;)I
    ...
    :goto_0
    const-string/jumbo v4, "validateNAPClient: Add profile to database failed. Exception"
    ...
    iput-object v1, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    iput-object v2, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, p1, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_bindAndActivate(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;II)V
...
.method public final _bindToClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;)I
    ...
    :try_start_0
    iget-object v4, p1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->handleObj:Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;
    ...
    iget-object v6, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;

    iget v7, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I
    ...
    iget-object v5, v5, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->binderMap:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v5, v6}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;

    const/4 v6, 0x0

    if-eqz v5, :cond_0

    iget-object v5, v5, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->napInterface:Lcom/samsung/android/knox/net/nap/serviceprovider/INetworkAnalyticsService;
    ...
    invoke-interface {v5}, Lcom/samsung/android/knox/net/nap/serviceprovider/INetworkAnalyticsService;->asBinder()Landroid/os/IBinder;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0, v4}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_unbindClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    ...
    const-string/jumbo v6, "_namonitoraction"
    ...
    invoke-virtual {v5, v6, v1, v7}, Landroid/content/pm/PackageManager;->queryIntentServicesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    iget-object v9, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;
    ...
    :cond_5
    iget-object v5, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v6, p1, v0, v5}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    const-string/jumbo v4, "_bindToClient:Exception"
...
.method public final _cleanUpConnectionDetails(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    ...
    iget-object v2, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->profilesForPackage:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    iget v3, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->activatedProfileCounter:I
    ...
    iput v3, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->activatedProfileCounter:I

    if-gez v3, :cond_1

    const/4 v2, 0x0

    iput v2, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->activatedProfileCounter:I

    :cond_1
    iget-object v1, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->profilesForPackage:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->binderMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final _unbindClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    ...
    :goto_1
    const-string/jumbo p1, "_unbindClient: Exception"
    ...
    :goto_2
    const-string/jumbo p1, "_unbindClient: RemoteException"
...
.method public final activateProfile(Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;I)I
    ...
    const-string v1, "Activate profile config storage returned = "
    ...
    :try_start_1
    invoke-virtual {v2, v4, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->isProfileActivatedForUser(ILjava/lang/String;)I

    move-result v2

    if-ne v2, p2, :cond_0

    const-string/jumbo p0, "activateProfile:Profile is already in the activated state for the user."
    ...
    iget v2, p1, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->adminUid:I
    ...
    invoke-virtual {p0, v2, v4, p2, p1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->activateProfile(IIILjava/lang/String;)I
...
.method public final getNetworkMonitorProfiles(Lcom/samsung/android/knox/ContextInfo;)Ljava/util/List;
    ...
    const-string v0, "Get NVM client profiles. Exception"
...
.method public final declared-synchronized handleNAPClientCall(Ljava/lang/String;Landroid/os/Bundle;Z)I
    ...
    :cond_4
    :try_start_2
    iget-object v13, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v15, "isAllowedRecordingForUsers: App is installed in User 0. Can record for any user."
    ...
    :cond_7
    iget v13, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I
    ...
    :try_start_4
    iget v13, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->userId:I
    ...
    :cond_e
    const-string/jumbo v6, "interval_value"

    invoke-virtual {v2, v6, v14}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I
    ...
    sget-object v10, Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;->KNOX_ENTERPRISE_SDK_VERSION_3_3:Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;
    ...
    invoke-virtual {v11}, Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;->getInternalVersion()Ljava/lang/String;
    ...
    const-string/jumbo v2, "handleNAPClientCall: intermediate flows : current knox version : "

    invoke-virtual {v13, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v13, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v2, " supported knox version : "
    ...
    invoke-static {v11, v10}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->versionCompare(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_11
    :try_start_8
    iget-object v2, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mConfigStore:Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;

    iget-object v2, v2, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->activationMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_13
    iget v11, v10, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;->activationState:I

    const/4 v13, 0x1

    if-ne v13, v11, :cond_12

    iget v11, v10, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;->activationFlowType:I

    if-ne v11, v15, :cond_14

    iget v10, v10, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPProfileActivation;->activationIntervalValue:I
    ...
    :cond_15
    :try_start_9
    iput v15, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->flowTypeForProfile:I

    iput v6, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->intervalValueForProfile:I
    ...
    sget-object v2, Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;->KNOX_ENTERPRISE_SDK_VERSION_3_3:Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;
    ...
    invoke-static {v6, v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->versionCompare(Ljava/lang/String;Ljava/lang/String;)I

    move-result v2

    if-gez v2, :cond_16

    iget-object v2, v1, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDriver:Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;

    const/4 v6, 0x0

    invoke-virtual {v2, v6}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->openCharDevice(I)I
    ...
    invoke-virtual {v2, v13}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->openCharDevice(I)I
    ...
    invoke-virtual {v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->checkNcmVersionMismatch()I
    ...
    :cond_1a
    :try_start_e
    iget v2, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->userId:I
    ...
    iget-object v10, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->profileName:Ljava/lang/String;

    iget v11, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    invoke-virtual {v2, v11, v8, v10}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->updateBindUserIdForProfile(IILjava/lang/String;)I
    ...
    const-string/jumbo v13, "handleNAPClientCall: bind userId updation failed for profile:"
    ...
    invoke-virtual {v2, v11, v10}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->isProfileActivatedForUser(ILjava/lang/String;)I
    ...
    const-string/jumbo v13, "handleNAPClientCall: bind userId updation failed for profile after default check:"
    ...
    const-string/jumbo v13, "handleNAPClientCall: activation failed for profile:"
    ...
    iput v8, v10, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I

    iget v4, v4, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    const/4 v13, 0x1

    invoke-virtual {v1, v13, v3, v4, v10}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->sendMessageToHandler(IIILjava/lang/Object;)V
...
.method public final registerNetworkMonitorProfile(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)I
    ...
    const-string/jumbo v4, "NETWORK_ANALYTICS_PARAMETERS"
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->validateJsonContent(Lorg/json/JSONObject;)I
    ...
    invoke-virtual {v1, v4, v3, p2, v5}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->addProfileToDatabase(ILorg/json/JSONObject;Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getClientProfileNames(I)Ljava/util/List;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->setFeatureProperty(Z)V
    ...
    invoke-static {v3, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getProfileObjectFromJson(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
...
.method public final setFeatureProperty(Z)V
    ...
    const-string/jumbo v2, "Unable to set NPA feature property"
...
.method public final setupIntentFilter()V
    ...
    invoke-static {v0, v3, v4, v5, v6}, Lcom/android/server/VpnManagerService$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/content/IntentFilter;
...
.method public final unregisterNetworkMonitorProfile(ILjava/lang/String;)I
    ...
    invoke-virtual {v10, v9}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getProfileforName(Ljava/lang/String;)Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;
    ...
    :cond_3
    invoke-virtual {p0, v9, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->activateProfile(Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;I)I
    ...
    invoke-virtual {v9}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->toString()Ljava/lang/String;
    ...
    iget v11, v9, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->userId:I

    iput v11, v10, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I

    iget v9, v9, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->opUserId:I

    invoke-virtual {p0, v2, v1, v9, v10}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->sendMessageToHandler(IIILjava/lang/Object;)V
    ...
    iget-object v5, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->profileMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string/jumbo v0, "removeProfileFromDatabase: Profile name not found "

    const-string/jumbo v5, "NetworkAnalytics:ConfigStore"

    invoke-static {v0, p2, v5}, Lcom/android/server/DualAppManagerService$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v8, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->mStorageHelper:Lcom/android/server/enterprise/nap/NetworkAnalyticsStorageHelper;
    ...
    invoke-virtual {v8, v9, v5, v7}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->deleteDataByFields(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_7

    invoke-virtual {v0, p1, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->updateTablesForProfileRemoval(ILjava/lang/String;)V
...
.method public final validateNAPClient(IILjava/lang/String;)I
    ...
    const-string/jumbo p0, "_validateNAPClient: Package signature could not be matched for profile entry/entries"
