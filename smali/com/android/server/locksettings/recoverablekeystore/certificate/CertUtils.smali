...
.method public static varargs getXmlNodeContents(ILorg/w3c/dom/Element;[Ljava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo p1, "The XML file must contain exactly one path with the tag "
    ...
    invoke-static {p1, v1}, Lcom/android/server/locksettings/recoverablekeystore/certificate/CertUtils;->getXmlDirectChildren(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo v0, "The XML file must contain exactly one node with the path "
    ...
    const-string/jumbo v0, "The XML file must contain at least one node with the path "
    ...
    const-string/jumbo p1, "The tag list must not be empty"
...
.method public static validateCertPath(Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/cert/CertPath;)V
    ...
    const-string/jumbo p1, "The given certificate path does not contain X509 certificates"
    ...
    const-string/jumbo p1, "The given certificate path is empty"
