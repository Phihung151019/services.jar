...
.method public final declared-synchronized get(I)Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    :try_start_3
    invoke-static {v2}, Lcom/android/server/locksettings/recoverablekeystore/serialization/KeyChainSnapshotDeserializer;->deserializeInternal(Ljava/io/InputStream;)Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    const-string/jumbo v5, "Malformed KeyChainSnapshot XML"
    ...
    .catch Lcom/android/server/locksettings/recoverablekeystore/serialization/KeyChainSnapshotParserException; {:try_start_7 .. :try_end_7} :catch_0
    ...
    const-string/jumbo v0, "RecoverySnapshotStorage"
    ...
    const-string/jumbo v2, "Snapshot for uid %d not found"
