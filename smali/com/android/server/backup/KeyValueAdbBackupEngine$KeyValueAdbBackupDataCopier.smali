...
.method public final run()V
    ...
    const-string/jumbo v0, "Writing key-value package payload"

    const-string/jumbo v4, "Writing manifest for "

    :try_start_0
    new-instance v10, Landroid/app/backup/FullBackupDataOutput;

    iget-object v5, v1, Lcom/android/server/backup/KeyValueAdbBackupEngine$KeyValueAdbBackupDataCopier;->mPipe:Landroid/os/ParcelFileDescriptor;

    invoke-direct {v10, v5}, Landroid/app/backup/FullBackupDataOutput;-><init>(Landroid/os/ParcelFileDescriptor;)V

    new-instance v11, Lcom/android/server/backup/fullbackup/AppMetadataBackupWriter;

    iget-object v5, v1, Lcom/android/server/backup/KeyValueAdbBackupEngine$KeyValueAdbBackupDataCopier;->this$0:Lcom/android/server/backup/KeyValueAdbBackupEngine;

    iget-object v5, v5, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-direct {v11, v10, v5}, Lcom/android/server/backup/fullbackup/AppMetadataBackupWriter;-><init>(Landroid/app/backup/FullBackupDataOutput;Landroid/content/pm/PackageManager;)V
    ...
    iget-object v12, v1, Lcom/android/server/backup/KeyValueAdbBackupEngine$KeyValueAdbBackupDataCopier;->mPackage:Landroid/content/pm/PackageInfo;

    iget-object v4, v1, Lcom/android/server/backup/KeyValueAdbBackupEngine$KeyValueAdbBackupDataCopier;->this$0:Lcom/android/server/backup/KeyValueAdbBackupEngine;

    iget-object v13, v4, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mManifestFile:Ljava/io/File;

    iget-object v14, v4, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mDataDir:Ljava/io/File;
    ...
    iget-object v4, v4, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mManifestFile:Ljava/io/File;
    ...
    iget-object v0, v0, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mDataDir:Ljava/io/File;
    ...
    iget-object v0, v0, Lcom/android/server/backup/KeyValueAdbBackupEngine;->mBackupDataName:Ljava/io/File;
    ...
    :catch_0
    :try_start_2
    const-string/jumbo v0, "Unable to finalize backup stream!"
    ...
    iget-object v0, v0, Lcom/android/server/backup/UserBackupManagerService;->mBackupManagerBinder:Landroid/app/backup/IBackupManager;
    ...
    :goto_4
    iget-object v1, v1, Lcom/android/server/backup/KeyValueAdbBackupEngine$KeyValueAdbBackupDataCopier;->mPipe:Landroid/os/ParcelFileDescriptor;
